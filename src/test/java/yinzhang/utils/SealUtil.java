...
public abstract class SealUtil {
    ...
    private final static int CENTER_INIT_BEGIN = 5;
    private final static int CENTER_INIT_BEGIN_T = 40;
    ...
    public static void buildAndStoreSeal(SealConfiguration conf, String fullPath) throws Exception {
    	byte[] seal = buildBytes(buildSeal(conf));
    	BASE64Encoder encoder = new BASE64Encoder();
        String png_base64 =  encoder.encodeBuffer(seal).trim();//转换成base64串
    ...
    public static BufferedImage buildSeal(SealConfiguration conf) throws Exception {
        ...
        //1.画布
        BufferedImage bi = new BufferedImage(conf.getImageSizeX(), conf.getImageSizeY(), BufferedImage.TYPE_4BYTE_ABGR);
        ...
        //2.3填充矩形
        g2d.fillRect(0, 0, conf.getImageSizeX(), conf.getImageSizeY());
        ...
        //8.画中心字
        drawFont(g2d, (borderCircleWidth + INIT_BEGIN) * 2, (borderCircleHeight + CENTER_INIT_BEGIN) * 2,
                conf.getCenterFont());
        //8.1.画中心字2
        drawFont(g2d, (borderCircleWidth + INIT_BEGIN) * 2, (borderCircleHeight + CENTER_INIT_BEGIN_T) * 2,
                conf.getCenterFont2());
